...
deal2 = Deal.new({ 'name' => 'The Grand Tour', 'flight_id' => flight2.id, 'day_id' => wednesday.id  })
deal3 = Deal.new({ 'name' => 'Historic sites', 'flight_id' => flight3.id, 'day_id' => thursday.id  })
deal4 = Deal.new({ 'name' => 'Ride the waves', 'flight_id' => flight4.id, 'day_id' => saturday.id  })
